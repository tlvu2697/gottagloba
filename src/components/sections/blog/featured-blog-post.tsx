...
export default function FeaturedBlogPost({ blogPost }: { blogPost: BlogPost }) {
  const { slug, title, summary, image, authors, date } = blogPost;
  const tagline = getTaglineCategory(blogPost);
